...
bool solve() {
  ...
  string tb2 = find_best(tb1, people[2]);
  string tb3 = find_best(tb2, people[3]);
  int tbest = cost(s, tb1) + cost(b1, tb2) + cost(b2, tb3) + cost(tb3, t);
  ...
  tb1 = find_best(s, people[1]);
  string tb12 = find_best(tb1, people[2]);
  tb3 = find_best(t, people[3]);
