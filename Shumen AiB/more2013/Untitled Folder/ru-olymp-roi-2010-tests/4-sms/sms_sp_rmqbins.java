...
public class sms_sp_rmqbins implements Runnable {

	public static void main(String[] args) {
		new Thread(new sms_sp_rmqbins()).start();
	}
...
//	}
	...
	public void solve() {
		...
		for (int i = 0; i < pers.length; i++) {
			int n = nextInt();
			myAssert((n >= 1) && (n <= 100000), "Too much friends");
			sum += n;
			pers[i] = new String[n];
			c[i] = new int[n];
		...
		myAssert(sum <= 100000, "Too much friends");
