...
int main(void)
{
	...
	for (int test = 0; test <= numTests; test++)
	{
		...
		else if (test == 15) randomTest(100000);
		else if (test == 16) flatTree(200000);
		else if (test == 17) shortTree(500000);
		else if (test == 18) shardedLine(800000);
		else if (test == 19) simpleLine(1000000);
		else if (test == 20) shardedLine(1000000);
